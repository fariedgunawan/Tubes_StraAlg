...
const Landing = () => { // Menerima addEntry sebagai prop
    ...
    <div className="body-landing px-[35px]">
      <div className="flex justify-center items-center min-h-screen flex-col text-center md:text-left md:items-start">
        ...
        <div className="flex flex-col items-center md:flex-row md:gap-[70px]">
          <button className="btn bg-[#415DBE] text-white hover:bg-white hover:text-[#415DBE] mt-[20px] md:text-[16px] md:px-[30px] md:rounded-2xl" onClick={() => navigate("/inputwaktu")}>Tampilkan Data Lari</button>
